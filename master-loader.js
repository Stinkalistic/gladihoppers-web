...
if (0 <= window.location.href.indexOf("pokiForceLocalLoader") 
	&& (loaders.unity = "https://cdn.statically.io/gh/Stinkalistic/gladihoppers-web/main/unity.js", 
...
if (!window.config.unityWebglLoaderUrl) {
    var versionSplit = window.config.unityVersion ? window.config.unityVersion.split(".") : [],
        ...
        minor = versionSplit[1];
          window.config.unityWebglLoaderUrl ="https://cdn.statically.io/gh/Stinkalistic/gladihoppers-web/main/UnityLoader.2019.2.js";
    // switch (year) {
    //     case "2019":
...
sdkScript.src = "https://cdn.statically.io/gh/Stinkalistic/gladihoppers-web/main/poki-sdk.js", sdkScript.onload = function() {
